...
var app = (function () {
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$4, 228, 2, 5122);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(video, file$4, 209, 3, 4390);
    			...
    			add_location(image, file$4, 210, 3, 4540);
    			add_location(a_assets, file$4, 208, 2, 4376);
    			...
    			add_location(a_marker, file$4, 217, 2, 4799);
    			set_custom_element_data(a_entity, "camera", "");
    			add_location(a_entity, file$4, 225, 2, 5070);
    			...
    			add_location(a_scene, file$4, 206, 1, 4279);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(206:1) {#if isBrowserValid}",
    		ctx
    	});
    ...
    function create_if_block_1$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(219:3) {#if template === \\\"video\\\"}",
    		ctx
    	});
