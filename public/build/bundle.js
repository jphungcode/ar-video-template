...
var app = (function () {
    ...
    // (99:0) {#if modelExt === "obj"}
    function create_if_block_1$1(ctx) {
    	let a_text;
    	let a_text_visible_value;
    	let t;
    	let a_entity;
    	...
    	const block = {
    		c: function create() {
    			...
    			set_custom_element_data(a_text, "value", "Model Loading");
    			set_custom_element_data(a_text, "visible", a_text_visible_value = /*status*/ ctx[0] === "component loaded");
    			set_custom_element_data(a_text, "rotation", "-90 0 0");
    			set_custom_element_data(a_text, "width", "1");
    			set_custom_element_data(a_text, "height", "1");
    			set_custom_element_data(a_text, "positon", "-0.5 0 0");
    			add_location(a_text, file$5, 99, 4, 2488);
    			set_custom_element_data(a_entity, "model-click", "");
    			set_custom_element_data(a_entity, "obj-model", objModelUrl);
    			set_custom_element_data(a_entity, "scale", "0.2 0.2 0.2");
    			set_custom_element_data(a_entity, "rotation", "-90 0 0");
    			add_location(a_entity, file$5, 100, 4, 2632);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*status*/ 1 && a_text_visible_value !== (a_text_visible_value = /*status*/ ctx[0] === "component loaded")) {
    				set_custom_element_data(a_text, "visible", a_text_visible_value);
    			}
    		},
    		d: function destroy(detaching) {
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(path0, file$5, 112, 93, 3418);
    			...
    			add_location(path1, file$5, 112, 459, 3784);
    			set_style(svg, "width", "100%");
    			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg, "viewBox", "0 0 475.2 475.2");
    			add_location(svg, file$5, 112, 8, 3333);
    			attr_dev(span, "id", "close-btn");
    			attr_dev(span, "class", "svelte-lpeh7s");
    			add_location(span, file$5, 111, 8, 3258);
    			add_location(h2, file$5, 114, 8, 4146);
    			add_location(p, file$5, 115, 8, 4182);
    			attr_dev(div0, "id", "model-detail");
    			attr_dev(div0, "class", "svelte-lpeh7s");
    			add_location(div0, file$5, 110, 4, 3225);
    			attr_dev(div1, "id", "modal");
    			attr_dev(div1, "class", "svelte-lpeh7s");
    			add_location(div1, file$5, 109, 0, 3158);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(109:0) {#if isModelDetailVisible}",
    		ctx
    	});
    ...
    function create_fragment$5(ctx) {
    	...
    	let if_block1 = /*isModelDetailVisible*/ ctx[1] && create_if_block$2(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a_text, file$5, 96, 0, 1955);
    			attr_dev(img, "id", "rotate-icon");
    			if (img.src !== (img_src_value = "./static/icons/rotating-circular-arrow.png")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "rotate icon");
    			attr_dev(img, "class", "svelte-lpeh7s");
    			add_location(img, file$5, 106, 0, 3036);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const objModelUrl = "obj: url(./static/models/chair/jean_obj.obj); mtl: url(./static/models/chair/jean_obj.mtl)";

    function instance$5($$self, $$props, $$invalidate) {
    	let status = "component loaded";
    	let isModelDetailVisible = true;
    	...
    	AFRAME.registerComponent("model-click", {
    		init() {
    			...
    			el.addEventListener("model-loaded", function () {
    				$$invalidate(0, status = "model loaded");
    			});
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$6, 259, 2, 6242);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$3(ctx) {
    	...
    	let a_entity;
    	let current;
    	const if_block_creators = [create_if_block_1$2, create_if_block_2, create_if_block_3, create_if_block_4];
    	const if_blocks = [];
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(video, file$6, 236, 3, 5334);
    			...
    			add_location(image, file$6, 237, 3, 5484);
    			add_location(a_assets, file$6, 235, 2, 5320);
    			...
    			add_location(a_marker, file$6, 244, 2, 5743);
    			set_custom_element_data(a_entity, "camera", "");
    			add_location(a_entity, file$6, 256, 2, 6190);
    			...
    			add_location(a_scene, file$6, 232, 1, 5107);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(232:1) {#if isBrowserValid}",
    		ctx
    	});
    ...
    function create_if_block_1$2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(246:3) {#if template === \\\"video\\\"}",
    		ctx
    	});
