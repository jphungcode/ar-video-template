    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$3, 205, 2, 4671);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(video, file$3, 190, 3, 3958);
    			...
    			add_location(image, file$3, 191, 3, 4108);
    			add_location(a_assets, file$3, 189, 2, 3944);
    			...
    			add_location(a_marker, file$3, 198, 2, 4363);
    			set_custom_element_data(a_entity, "camera", "");
    			add_location(a_entity, file$3, 202, 2, 4619);
    			...
    			add_location(a_scene, file$3, 187, 1, 3847);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(187:1) {#if isBrowserValid}",
    		ctx
    	});
