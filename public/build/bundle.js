...
var app = (function () {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$4, 220, 1, 6302);
    			attr_dev(section, "id", "cta-section");
    			attr_dev(section, "class", "svelte-w7f3j6");
    			add_location(section, file$4, 219, 0, 6273);
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a_text0, file$4, 209, 0, 4673);
    			...
    			add_location(a_image, file$4, 210, 0, 5168);
    			set_custom_element_data(a_text1, "wrap-count", a_text1_wrap_count_value = /*descriptionText*/ ctx[6].wrapCount);
    			set_custom_element_data(a_text1, "value", a_text1_value_value = /*descriptionText*/ ctx[6].text);
    			...
    			add_location(a_text1, file$4, 212, 0, 5543);
    			...
    			add_location(img0, file$4, 215, 0, 6101);
    			...
    			add_location(img1, file$4, 216, 0, 6174);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	const descriptionText = {
    		text: "Get that best-ever feeling on every run. These neutral shoes have a stretchy knit upper with ventilation in key sweat zones to help you stay cool. Energy-returning cushioning and a flexible outsole work together to give you a smooth ride from touch-down to toe-off.",
    		padding: 0.1,
    		position: {
    			x: descriptionBlock.position.x,
    			y: descriptionBlock.position.y + 0.05,
    ...
    // (36:0) {#if modelExt === "obj"}
    function create_if_block$2(ctx) {
    	let a_text;
    	let a_text_visible_value;
    	let t;
    	let a_entity;
    	let a_entity_visible_value;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a_text, file$5, 36, 4, 950);
    			set_custom_element_data(a_entity, "visible", a_entity_visible_value = /*status*/ ctx[0] === "model loaded");
    			set_custom_element_data(a_entity, "model-click", "");
    			set_custom_element_data(a_entity, "obj-model", objModelUrl);
    			set_custom_element_data(a_entity, "scale", "1 1 1");
    			add_location(a_entity, file$5, 37, 4, 1035);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty[0] & /*status*/ 1 && a_entity_visible_value !== (a_entity_visible_value = /*status*/ ctx[0] === "model loaded")) {
    				set_custom_element_data(a_entity, "visible", a_entity_visible_value);
    			}
    		},
    		d: function destroy(detaching) {
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$6, 260, 2, 6141);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(video, file$6, 236, 3, 5232);
    			...
    			add_location(image, file$6, 237, 3, 5382);
    			add_location(a_assets, file$6, 235, 2, 5218);
    			...
    			add_location(a_marker, file$6, 244, 2, 5641);
    			set_custom_element_data(a_entity, "camera", "");
    			add_location(a_entity, file$6, 257, 2, 6089);
    			...
    			add_location(a_scene, file$6, 232, 1, 5005);
    		},
    		m: function mount(target, anchor) {
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	onMount(() => {
    		...
    		switch (template) {
    			case "video":
    				$$invalidate(3, patternUrl = "pattern-video-qr-code.patt");
    				break;
    			case "image":
    				$$invalidate(3, patternUrl = "pattern-image-qr-code.patt");
    				break;
    			case "imagegallery":
    				$$invalidate(3, patternUrl = "pattern-imagegallery-qr-code.patt");
    				break;
    			case "3dmodel":
    				$$invalidate(3, patternUrl = "pattern-3dmodel-qr-code.patt");
    				break;
    			case "article":
    				$$invalidate(3, patternUrl = "pattern-article-qr-code.patt");
    				break;
    			default:
    				$$invalidate(3, patternUrl = "pattern-video-qr-code.patt");
    				break;
