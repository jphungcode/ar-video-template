    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a_text1, file$2, 17, 0, 1052);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$3, 187, 2, 4267);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(video, file$3, 172, 3, 3554);
    			...
    			add_location(image, file$3, 173, 3, 3704);
    			add_location(a_assets, file$3, 171, 2, 3540);
    			set_custom_element_data(a_marker, "preset", "custom");
    			set_custom_element_data(a_marker, "type", "pattern");
    			set_custom_element_data(a_marker, "url", "pattern-video-qr-code.patt");
    			add_location(a_marker, file$3, 180, 2, 3959);
    			set_custom_element_data(a_entity, "camera", "");
    			add_location(a_entity, file$3, 184, 2, 4215);
    			...
    			add_location(a_scene, file$3, 169, 1, 3443);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(169:1) {#if isBrowserValid}",
    		ctx
    	});
