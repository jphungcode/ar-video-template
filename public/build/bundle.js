...
var app = (function () {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", "svelte-hqiqnq");
    			add_location(button, file$4, 221, 1, 6300);
    			attr_dev(section, "id", "cta-section");
    			attr_dev(section, "class", "svelte-hqiqnq");
    			add_location(section, file$4, 220, 0, 6271);
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a_text0, file$4, 210, 0, 4671);
    			...
    			add_location(a_image, file$4, 211, 0, 5166);
    			...
    			add_location(a_text1, file$4, 213, 0, 5541);
    			...
    			attr_dev(img0, "class", "svelte-hqiqnq");
    			add_location(img0, file$4, 216, 0, 6099);
    			...
    			attr_dev(img1, "class", "svelte-hqiqnq");
    			add_location(img1, file$4, 217, 0, 6172);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	AFRAME.registerComponent("gallery-controls", {
    		init() {
    			...
    			this.aimage = document.getElementById("image-gallery");
    		...
    		nextImage(method) {
    			...
    			this.aimage.setAttribute("src", imageParams.src[this.index]);
    		}
    	});
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$5, 255, 2, 5974);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(video, file$5, 233, 3, 5123);
    			...
    			add_location(image, file$5, 234, 3, 5273);
    			add_location(a_assets, file$5, 232, 2, 5109);
    			...
    			add_location(a_marker, file$5, 241, 2, 5532);
    			set_custom_element_data(a_entity, "camera", "");
    			add_location(a_entity, file$5, 252, 2, 5922);
    			...
    			add_location(a_scene, file$5, 229, 1, 4896);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(229:1) {#if isBrowserValid}",
    		ctx
    	});
    ...
    function create_if_block_1$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(243:3) {#if template === \\\"video\\\"}",
    		ctx
    	});
