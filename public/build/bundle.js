...
var app = (function () {
    ...
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(path0, file$5, 170, 93, 5083);
    			...
    			add_location(path1, file$5, 170, 459, 5449);
    			set_style(svg, "width", "100%");
    			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg, "viewBox", "0 0 475.2 475.2");
    			add_location(svg, file$5, 170, 8, 4998);
    			attr_dev(span0, "id", "close-btn");
    			attr_dev(span0, "class", "svelte-1a8hnfa");
    			add_location(span0, file$5, 169, 8, 4923);
    			add_location(h2, file$5, 172, 8, 5811);
    			set_style(span1, "font-weight", "500");
    			add_location(span1, file$5, 174, 16, 5928);
    			attr_dev(li0, "class", "svelte-1a8hnfa");
    			add_location(li0, file$5, 174, 12, 5924);
    			set_style(span2, "font-weight", "500");
    			add_location(span2, file$5, 175, 16, 6026);
    			attr_dev(li1, "class", "svelte-1a8hnfa");
    			add_location(li1, file$5, 175, 12, 6022);
    			set_style(span3, "font-weight", "500");
    			add_location(span3, file$5, 176, 16, 6105);
    			attr_dev(li2, "class", "svelte-1a8hnfa");
    			add_location(li2, file$5, 176, 12, 6101);
    			set_style(span4, "font-weight", "500");
    			add_location(span4, file$5, 177, 16, 6209);
    			attr_dev(li3, "class", "svelte-1a8hnfa");
    			add_location(li3, file$5, 177, 12, 6205);
    			attr_dev(li4, "class", "svelte-1a8hnfa");
    			add_location(li4, file$5, 178, 12, 6274);
    			attr_dev(li5, "class", "svelte-1a8hnfa");
    			add_location(li5, file$5, 179, 12, 6316);
    			attr_dev(li6, "class", "svelte-1a8hnfa");
    			add_location(li6, file$5, 180, 12, 6357);
    			attr_dev(li7, "class", "svelte-1a8hnfa");
    			add_location(li7, file$5, 181, 12, 6407);
    			attr_dev(li8, "class", "svelte-1a8hnfa");
    			add_location(li8, file$5, 182, 12, 6452);
    			attr_dev(li9, "class", "svelte-1a8hnfa");
    			add_location(li9, file$5, 183, 12, 6494);
    			attr_dev(li10, "class", "svelte-1a8hnfa");
    			add_location(li10, file$5, 184, 12, 6544);
    			attr_dev(li11, "class", "svelte-1a8hnfa");
    			add_location(li11, file$5, 185, 12, 6593);
    			attr_dev(li12, "class", "svelte-1a8hnfa");
    			add_location(li12, file$5, 186, 12, 6636);
    			set_style(span5, "font-weight", "500");
    			add_location(span5, file$5, 187, 16, 6686);
    			attr_dev(li13, "class", "svelte-1a8hnfa");
    			add_location(li13, file$5, 187, 12, 6682);
    			set_style(span6, "font-weight", "500");
    			add_location(span6, file$5, 188, 16, 6762);
    			attr_dev(li14, "class", "svelte-1a8hnfa");
    			add_location(li14, file$5, 188, 12, 6758);
    			set_style(ul, "list-style", "none");
    			set_style(ul, "padding-left", "0");
    			set_style(ul, "font-size", "0.8rem");
    			add_location(ul, file$5, 173, 8, 5847);
    			attr_dev(div0, "id", "model-detail");
    			attr_dev(div0, "class", "svelte-1a8hnfa");
    			add_location(div0, file$5, 168, 4, 4890);
    			attr_dev(div1, "id", "modal");
    			attr_dev(div1, "class", "svelte-1a8hnfa");
    			add_location(div1, file$5, 167, 0, 4823);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(167:0) {#if isModelDetailVisible}",
    		ctx
    	});
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$5, 197, 8, 7000);
    			attr_dev(section, "id", "cta-section");
    			attr_dev(section, "class", "svelte-1a8hnfa");
    			add_location(section, file$5, 196, 4, 6925);
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a_text, file$5, 149, 0, 3347);
    			set_custom_element_data(a_entity0, "light", "type: ambient; color: #EEE");
    			add_location(a_entity0, file$5, 151, 0, 3850);
    			...
    			add_location(a_entity1, file$5, 152, 0, 3908);
    			...
    			add_location(a_entity2, file$5, 159, 0, 4419);
    			...
    			add_location(a_image, file$5, 162, 0, 4557);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<ModelTemplate> was created with unknown prop '${key}'`);
    	});
    ...
    class ModelTemplate extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*markerVisible*/ ctx[0] === undefined && !("markerVisible" in props)) {
    			console.warn("<ModelTemplate> was created without expected prop 'markerVisible'");
    		}
    	}
