...
var app = (function () {
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(path0, file$5, 114, 93, 3486);
    			...
    			add_location(path1, file$5, 114, 459, 3852);
    			set_style(svg, "width", "100%");
    			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg, "viewBox", "0 0 475.2 475.2");
    			add_location(svg, file$5, 114, 8, 3401);
    			attr_dev(span, "id", "close-btn");
    			attr_dev(span, "class", "svelte-lpeh7s");
    			add_location(span, file$5, 113, 8, 3326);
    			add_location(h2, file$5, 116, 8, 4214);
    			add_location(p, file$5, 117, 8, 4250);
    			attr_dev(div0, "id", "model-detail");
    			attr_dev(div0, "class", "svelte-lpeh7s");
    			add_location(div0, file$5, 112, 4, 3293);
    			attr_dev(div1, "id", "modal");
    			attr_dev(div1, "class", "svelte-lpeh7s");
    			add_location(div1, file$5, 111, 0, 3226);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(111:0) {#if isModelDetailVisible}",
    		ctx
    	});
    ...
    function create_fragment$5(ctx) {
    	...
    	let if_block = /*isModelDetailVisible*/ ctx[1] && create_if_block$2(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			set_custom_element_data(a_text0, "align", a_text0_align_value = /*titleText*/ ctx[3].align);
    			set_custom_element_data(a_text0, "anchor", a_text0_anchor_value = /*titleText*/ ctx[3].anchor);
    			add_location(a_text0, file$5, 96, 0, 1982);
    			set_custom_element_data(a_text1, "value", "Model Loading");
    			set_custom_element_data(a_text1, "visible", a_text1_visible_value = /*status*/ ctx[0] === "component loaded");
    			set_custom_element_data(a_text1, "rotation", "-90 0 0");
    			set_custom_element_data(a_text1, "width", "1");
    			set_custom_element_data(a_text1, "height", "1");
    			set_custom_element_data(a_text1, "positon", "-0.5 0 0");
    			add_location(a_text1, file$5, 102, 4, 2726);
    			set_custom_element_data(a_entity, "model-click", "");
    			set_custom_element_data(a_entity, "gltf-model", "#model");
    			set_custom_element_data(a_entity, "rotation", "0 0 0");
    			set_custom_element_data(a_entity, "scale", "1 1 1");
    			add_location(a_entity, file$5, 103, 4, 2870);
    			...
    			add_location(a_image, file$5, 106, 0, 2962);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, dirty) {
    			if (!current || dirty[0] & /*status*/ 1 && a_text1_visible_value !== (a_text1_visible_value = /*status*/ ctx[0] === "component loaded")) {
    				set_custom_element_data(a_text1, "visible", a_text1_visible_value);
    			}
